...
func (e *ExportGroupField) IsField() {}

func (f *ExportGroupField) UnmarshalYAML(unmarshal func(interface{}) error) error {
...
func (f *ExportGroupField) GetFieldName() string {
	if f.Object != nil {
...
func (f *ExportGroupField) GetColumnName() string {
	if f.Object != nil {
...
func (f *ExportGroupField) IsMappedData() bool {
